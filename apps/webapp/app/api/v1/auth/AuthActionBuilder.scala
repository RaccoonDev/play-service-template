...
/**
 * A wrapped request for auth resources.
 *
...
/**
 * The action builder for the Auth resource.
 *
 * This is the place to put logging, metrics, to augment
 * the request with contextual data, and manipulate the
 * result.
 */
class AuthActionBuilder (messagesApi: MessagesApi,
...
/**
 * Packages up the component dependencies for the auth controller.
 *
 * This is a good way to minimize the surface area exposed to the controller, so the
 * controller only has to have one thing injected.
 */
case class AuthControllerComponents (
                                               authActionBuilder: AuthActionBuilder,
                                               authResourceHandler: AuthResourceHandler,
...
/**
 * Exposes actions and handler to the AuthController by wiring the injected state into the base class.
 */
class AuthBaseController (acc: AuthControllerComponents)
  ...
  def authResourceHandler: AuthResourceHandler = acc.authResourceHandler
}